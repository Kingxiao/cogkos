...
pub enum TaskType {
    ...
    /// Content consolidation — episodic turns → semantic facts (2h cycle)
    ContentConsolidation,
    /// LLM deep extraction — episodic → structured facts + relation triples (4h cycle)
    LlmExtraction,
}
...
impl TaskType {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            TaskType::ContentConsolidation => "content_consolidation",
            TaskType::LlmExtraction => "llm_extraction",
        }
    }
}
...
pub struct SchedulerConfig {
    ...
    /// Content consolidation interval in seconds
    pub content_consolidation_interval_secs: u64,
    /// LLM extraction interval in seconds
    pub llm_extraction_interval_secs: u64,
...
impl Default for SchedulerConfig {
    fn default() -> Self {
        ...
        task_budget_percentages.insert(TaskType::ContentConsolidation.name().to_string(), 3);
        task_budget_percentages.insert(TaskType::LlmExtraction.name().to_string(), 2);
        ...
        Self {
            ...
            content_consolidation_interval_secs: 2 * 3600, // 2 hours
            llm_extraction_interval_secs: 4 * 3600,        // 4 hours
...
pub struct SchedulerState {
    ...
    pub last_content_consolidation: Option<chrono::DateTime<chrono::Utc>>,
    pub last_llm_extraction: Option<chrono::DateTime<chrono::Utc>>,
...
impl Default for SchedulerState {
    fn default() -> Self {
        Self {
            ...
            last_content_consolidation: None,
            last_llm_extraction: None,
            tasks_processed: 0,
