...
pub struct Scheduler {
    ...
    /// LLM client for deep extraction (optional — requires LLM_EXTRACTION_ENABLED=true).
    pub(crate) llm_client: Option<Arc<dyn cogkos_llm::LlmClient>>,
}
...
impl Scheduler {
    ...
    /// Set the LLM client for deep extraction tasks.
    pub fn with_llm_client(mut self, client: Arc<dyn cogkos_llm::LlmClient>) -> Self {
