        ...
        let result = tokio::time::timeout(std::time::Duration::from_secs(timeout_secs), async {
            match tool_name.as_str() {
                ...
                "federation_register_node" => {
                    ...
                    let req: crate::tools::federation::RegisterNodeRequest =
                        serde_json::from_value(serde_json::Value::Object(arguments.clone()))
                            .map_err(|e| {
                                rmcp::ErrorData::new(
                                    ErrorCode::INVALID_PARAMS,
                    ...
                    let response = crate::tools::federation::handle_federation_register_node(
                        req,
                        self.state.federation_client.clone(),
                    )
                    .await
                    .map_err(|e| rmcp::ErrorData::internal_error(e.to_string(), None))?;
                    Ok(CallToolResult::success(vec![Content::text(
                ...
                "federation_query" => {
                    ...
                    let req: crate::tools::federation::FederationQueryRequest =
                        serde_json::from_value(serde_json::Value::Object(arguments.clone()))
                            .map_err(|e| {
                                rmcp::ErrorData::new(
                                    ErrorCode::INVALID_PARAMS,
                    ...
                    let response = crate::tools::federation::handle_federation_query(
                        req,
                        self.state.federation_client.clone(),
                    )
                    .await
                ...
                "federation_health" => {
                    let response = crate::tools::federation::handle_federation_health(
                        self.state.federation_client.clone(),
                    )
                    .await
                    .map_err(|e| rmcp::ErrorData::internal_error(e.to_string(), None))?;
                ...
                "federation_export_insights" => {
                    ...
                    let req: crate::tools::federation::ExportInsightsRequest =
                        serde_json::from_value(serde_json::Value::Object(arguments.clone()))
                            .map_err(|e| {
                                rmcp::ErrorData::new(
                                    ErrorCode::INVALID_PARAMS,
                    ...
                    let response = crate::tools::federation::handle_federation_export_insights(
                        req,
                        &auth_context.tenant_id,
                        self.state.stores.claims.as_ref(),
                    )
                ...
                "system_health" => {
                    let response = crate::tools::system::handle_system_health(
                        &auth_context.tenant_id,
                ...
                "evolution_status" => {
                    let response = crate::tools::system::handle_evolution_status(
                        &auth_context.tenant_id,
                        self.state.stores.clone(),
                    )
                    .await
                ...
                "system_introspection" => {
                    let response = crate::tools::system::handle_system_introspection(
                        self.state.stores.clone(),
                    )
                    .await
                    .map_err(|e| rmcp::ErrorData::internal_error(e.to_string(), None))?;
...
mod tests {
    ...
    fn build_tools_returns_all_tools() {
        ...
        assert_eq!(tools.len(), 19); // 12 core + 4 federation + 3 system
    }
